...
def train_model(args):
	...
	if accelerator.is_main_process:
		...
		logger.info("Patience: {} Reduce factor: {} Batch size: {} Optimizer: {}".format(config.training.patience, config.training.reduce_factor, batch_size, config.training.optimizer))
