...
class CommonSeparator:
    ...
    def __init__(self, config):
        ...
        self.primary_stem_name = self.model_data.get("primary_stem", "Vocals")
        if self.primary_stem_name == "Vocals" or self.primary_stem_name == "vocals":
            self.secondary_stem_name = "Instrumental"
        if self.primary_stem_name == "Instrumental" or self.primary_stem_name == "instrumental":
            self.secondary_stem_name = "Vocals"
        if self.primary_stem_name != "Vocals" and self.primary_stem_name != "vocals" and self.primary_stem_name != "Instrumental" and self.primary_stem_name != "instrumental":
            if self.primary_stem_name.startswith("No "):
                self.secondary_stem_name = self.primary_stem_name[3:]
                self.secondary_stem_name = self.secondary_stem_name[0].upper() + self.secondary_stem_name[1:]
            else:
                self.secondary_stem_name = "No " + self.primary_stem_name
