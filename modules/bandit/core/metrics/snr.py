...
class BaseChunkMedianSignalRatio(tm.Metric):
	def __init__(self, func: Callable, window_size: int, hop_size: int = None, zero_mean: bool = False) -> None:
		super().__init__()
...
class ChunkMedianSignalNoiseRatio(BaseChunkMedianSignalRatio):
	def __init__(self, window_size: int, hop_size: int = None, zero_mean: bool = False) -> None:
		super().__init__(func=tmF.signal_noise_ratio, window_size=window_size, hop_size=hop_size, zero_mean=zero_mean)


class ChunkMedianScaleInvariantSignalNoiseRatio(BaseChunkMedianSignalRatio):
	def __init__(self, window_size: int, hop_size: int = None, zero_mean: bool = False) -> None:
		super().__init__(func=tmF.scale_invariant_signal_noise_ratio, window_size=window_size, hop_size=hop_size, zero_mean=zero_mean)


class ChunkMedianSignalDistortionRatio(BaseChunkMedianSignalRatio):
	def __init__(self, window_size: int, hop_size: int = None, zero_mean: bool = False) -> None:
		super().__init__(func=tmF.signal_distortion_ratio, window_size=window_size, hop_size=hop_size, zero_mean=zero_mean)


class ChunkMedianScaleInvariantSignalDistortionRatio(BaseChunkMedianSignalRatio):
	def __init__(self, window_size: int, hop_size: int = None, zero_mean: bool = False) -> None:
		super().__init__(func=tmF.scale_invariant_signal_distortion_ratio, window_size=window_size, hop_size=hop_size, zero_mean=zero_mean)
