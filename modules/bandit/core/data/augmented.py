...
class AugmentedDataset(data.Dataset):
	def __init__(self, dataset: data.Dataset, augmentation: nn.Module = nn.Identity(), target_length: Optional[int] = None) -> None:
		warnings.warn("This class is no longer used. Attach augmentation to " "the LightningSystem instead.", DeprecationWarning)
